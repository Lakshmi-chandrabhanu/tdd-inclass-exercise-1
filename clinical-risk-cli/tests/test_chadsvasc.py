...
class TestCHADS2VASc(unittest.TestCase):
    ...
    def test_negative_age_raises_error(self):
        # Test case for negative age, which should raise ValueError
        with self.assertRaises(ValueError):
            cha2ds2_vasc_score(age=-5, female=False, chf=False, htn=False, dm=False, stroke=False, vascular=False)   